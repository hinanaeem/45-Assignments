...
let current_users = ["Admin", "Eric", "Meerab", "Hammad", "Neha"];
let new_users = ["Admin", "Eric", "Aliza", "Haiqa", "Haider"];
let current_users_lower = current_users.map(user3 => user3.toLowerCase());
