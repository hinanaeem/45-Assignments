...
let countries: string[]= ["Pakistan", "China","America","Korea","Japan","Bangladesh"];
let orignalOrder: string[] = countries.slice();
console.log("Orignal order" , [orignalOrder]);
...
console.log(`Reverse Alphabatical Order [${countries.sort()}]`);
